...
export default async function Footer() {
  ...
  return (
    <footer className="border-t border-hairline bg-cream">
      ...
      <div className="container-studio flex flex-col items-center justify-between gap-4 border-t border-hairline py-8 text-[13px] uppercase tracking-widest2 text-muted md:flex-row">
